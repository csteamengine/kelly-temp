...
class UpdateThemeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'background_image' => 'nullable|mimes:pdf,jpeg,jpg,png,mp4',
            'about_image' => 'nullable|image',
            'favicon' => 'nullable|image',
            'is_maintenance_mode' => 'sometimes|boolean',
            'contact_submit_active' => 'sometimes|boolean',
            'contact_active' => 'sometimes|boolean',
            'resume_active' => 'sometimes|boolean',
            'about_active' => 'sometimes|boolean',
            'blogs_active' => 'sometimes|boolean',
